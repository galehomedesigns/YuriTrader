#!/usr/bin/env python3
"""Render canvas/opening-sim-liveengine.html from logs/opening_sim_multi_2min.json via the shared
...
OUT = HERE.parents[2] / "canvas" / "opening-sim-liveengine.html"
SUMMARY = HERE.parent / "logs" / "opening_sim_multi_2min.json"
def main() -> None:
    ...
    OUT.write_text(html)
    print(f"[opening-sim-liveengine] wrote {OUT}")
